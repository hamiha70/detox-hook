...
library PoolParameters {
    ...
    function calculateTotalETHNeeded(
        DeploymentParams memory params
    ) internal pure returns (uint256 totalETH) {
    ...
    function calculateTotalUSDCNeeded(
        DeploymentParams memory params
    ) internal pure returns (uint256 totalUSDC) {
        ...
        uint256 demoUSDC = params.demoAccountFunding *
            params.demoAccounts.length;
    ...
    function getDeploymentKeyEnvVar(
        uint256 chainId
