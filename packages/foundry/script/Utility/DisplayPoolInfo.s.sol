...
contract DisplayPoolInfo is Script {
    ...
    function _displayPool1() internal view {
        ...
        console.log(
            "PoolId: 0x5e6967b5ca922ff1aa7f25521cfd03d9a59c17536caa09ba77ed0586c238d23f"
        );
    ...
    function _displayPool2() internal view {
        ...
        console.log(
            "PoolId: 0x10fe1bb5300768c6f5986ee70c9ee834ea64ea704f92b0fd2cda0bcbe829ec90"
        );
    ...
    function _displayPoolKeys() internal view {
        ...
        console.log(
            "  Computed PoolId:",
            vm.toString(PoolId.unwrap(poolKey1.toId()))
        );
        ...
        console.log(
            "  Computed PoolId:",
            vm.toString(PoolId.unwrap(poolKey2.toId()))
        );
    }
    ...
    function getBothPoolKeys()
        external
        view
        returns (PoolKey memory pool1, PoolKey memory pool2)
    {
