...
def test_price_reading():
    ...
    try:
        ...
        if "0x14aebe68" in error_str:
            ...
            print("📋 Rate limit exceeded - try again in a few minutes")
...
def update_price_feed(update_data):
    ...
    try:
        ...
        if "429" in error_str or "Too Many Requests" in error_str:
            print("📋 Rate limit exceeded - try again in a few minutes")
            print("💡 Consider using a different RPC endpoint or waiting")
        elif "insufficient funds" in error_str.lower():
            print("📋 Insufficient funds for transaction")
        elif "nonce" in error_str.lower():
            print("📋 Nonce error - transaction may have been sent already")
